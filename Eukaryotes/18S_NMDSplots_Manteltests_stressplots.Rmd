...
saveRDS(sampleplot_transect_Euk,"~/Desktop/Transect_betadiv_18S.rds")
saveRDS(NMDS.ord_transect_Euk,"~/Desktop/18S_transect_stressplot.rds")
```
...
dev.copy(png,"Beta Diversity profile Eukonly", units = "in", width = 6, height = 5, res = 500)
dev.off()
...
saveRDS(sampleplot_profile_Euk,"~/Desktop/Profile_betadiv_18S.rds")
saveRDS(NMDS.ord_profile_Euk,"~/Desktop/18S_profile_stressplot.rds")
```
