...
saveRDS(NMDS_Multi,"~/Multifjord_betadiv_16S.rds")
saveRDS(NMDS.ord_inout,"~/16S_Multi_stressplot.rds")
```
...
saveRDS(NMDS_Hor,"~/To_ggarrange/Transect_betadiv_16S.rds")
saveRDS(NMDS.ord_Hor,"~/16S_Transect_stressplot.rds")
```
...
saveRDS(Surface_CTD_regression,"~/surface_CTD_regression.rds")
saveRDS(D10_CTD_regression,"~/10m_CTD_regression.rds")
...
saveRDS(sampleplot,"~/Profile_betadiv_16S.rds")
saveRDS(NMDS.ord_Vert,"~/16S_Profile_stressplot.rds")
```
...
saveRDS(CTD_regression,"~/Profile_CTD_regression.rds")
```
