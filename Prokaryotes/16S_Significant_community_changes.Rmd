...
```
#Signficantly changing five fjords community
...
```{r Export consensus}
saveRDS(Summary_all_plot,"~/Phylum_EdgeR_Consensus_16S.rds")
...
#Add distance to phyloseq object
##Read in .csv file
CTDtoadd = read.csv("~/Required Files/Hor_CTDtoAdd.csv", row.names = 1)
...
##Export for ggarrange
```{r Export horizontal}
saveRDS(Summary_plot_Transect_Dist,"~/Phylum_EdgeR_Transect_16S_Dist.rds")
saveRDS(Summary_plot_Transect_Sal,"~/Phylum_EdgeR_Transect_16S_Sal.rds")
saveRDS(Summary_plot_Transect_Temp,"~/Phylum_EdgeR_Transect_16S_Temp.rds")
saveRDS(Summary_plot_Transect_Ox,"~/Phylum_EdgeR_Transect_16S_Ox.rds")
```
...
##Export for ggarrange
```{r Export vertical}
saveRDS(Summary_plot,"~/Phylum_EdgeR_Profile_16S_Depth.rds")
saveRDS(Summary_plot_Ox,"~/Phylum_EdgeR_Profile_16S_Ox.rds")
saveRDS(Summary_plot_Sal,"~/Phylum_EdgeR_Profile_16S_Sal.rds")
saveRDS(Summary_plot_Temp,"~/Phylum_EdgeR_Profile_16S_Temp.rds")
```
